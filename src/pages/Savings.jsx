...
import {
  PiggyBank, DollarSign, TrendingUp, TrendingDown,
...
export default function Savings() {
  ...
  // Fetch transactions from Supabase with SWR
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        ...
        <div className={`border rounded-2xl p-5 shadow-sm ${netSavings >= 0 ? 'bg-gradient-to-br from-green-50 to-emerald-50 border-green-200' : 'bg-gradient-to-br from-red-50 to-rose-50 border-red-200'}`}>
          <div className="flex items-center justify-between mb-3">
            ...
            <span className={`text-[10px] px-2 py-0.5 rounded-full font-bold ${netSavings >= 0 ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'}`}>
              NET
            </span>
          </div>
